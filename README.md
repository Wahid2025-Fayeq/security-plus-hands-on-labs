...
All activities documented in this repository are performed only in controlled environments using systems that I own or am explicitly authorized to test.
